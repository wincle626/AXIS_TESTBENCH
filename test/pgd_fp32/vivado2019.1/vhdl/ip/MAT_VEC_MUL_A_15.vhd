...
entity MAT_VEC_MUL_A_15_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of MAT_VEC_MUL_A_15_rom is 
...
architecture arch of MAT_VEC_MUL_A_15 is
    component MAT_VEC_MUL_A_15_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    MAT_VEC_MUL_A_15_rom_U :  component MAT_VEC_MUL_A_15_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
