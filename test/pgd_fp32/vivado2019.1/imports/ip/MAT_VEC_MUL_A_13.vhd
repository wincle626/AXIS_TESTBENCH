...
entity MAT_VEC_MUL_A_13_rom is 
    generic(
             DWIDTH     : integer := 32; 
             AWIDTH     : integer := 4; 
             MEM_SIZE    : integer := 16
...
architecture rtl of MAT_VEC_MUL_A_13_rom is 
...
architecture arch of MAT_VEC_MUL_A_13 is
    component MAT_VEC_MUL_A_13_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    MAT_VEC_MUL_A_13_rom_U :  component MAT_VEC_MUL_A_13_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
