...
architecture rtl of pgd_f32_AtA_0_rom is 
...
architecture arch of pgd_f32_AtA_0 is
    component pgd_f32_AtA_0_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pgd_f32_AtA_0_rom_U :  component pgd_f32_AtA_0_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
