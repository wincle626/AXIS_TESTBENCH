...
architecture rtl of pgd_f32_AtA_4_rom is 
...
architecture arch of pgd_f32_AtA_4 is
    component pgd_f32_AtA_4_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pgd_f32_AtA_4_rom_U :  component pgd_f32_AtA_4_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
