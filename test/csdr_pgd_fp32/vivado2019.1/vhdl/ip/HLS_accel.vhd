...
architecture behav of HLS_accel is 
    ...
    "HLS_accel,hls_ip_2019_1_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xczu7ev-ffvc1156-2-e,HLS_INPUT_CLOCK=3.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.563000,HLS_SYN_LAT=6514,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=36,HLS_SYN_FF=18877,HLS_SYN_LUT=11393,HLS_VERSION=2019_1_3}";
    ...
    signal grp_wrapped_csdr_pgd_hw_fu_128_ap_start : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_ap_done : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_ap_idle : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_ap_ready : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TVALID : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TREADY : STD_LOGIC;
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TKEEP : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TUSER : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TLAST : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TID : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDEST : STD_LOGIC_VECTOR (4 downto 0);
    signal grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg : STD_LOGIC := '0';
    ...
    component wrapped_csdr_pgd_hw IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    grp_wrapped_csdr_pgd_hw_fu_128 : component wrapped_csdr_pgd_hw
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        ap_start => grp_wrapped_csdr_pgd_hw_fu_128_ap_start,
        ap_done => grp_wrapped_csdr_pgd_hw_fu_128_ap_done,
        ap_idle => grp_wrapped_csdr_pgd_hw_fu_128_ap_idle,
        ap_ready => grp_wrapped_csdr_pgd_hw_fu_128_ap_ready,
        INPUT_STREAM_TDATA => INPUT_STREAM_data_V_0_data_out,
        INPUT_STREAM_TVALID => grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TVALID,
        INPUT_STREAM_TREADY => grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY,
        ...
        OUTPUT_STREAM_TDATA => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDATA,
        OUTPUT_STREAM_TVALID => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID,
        OUTPUT_STREAM_TREADY => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TREADY,
        OUTPUT_STREAM_TKEEP => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TKEEP,
        OUTPUT_STREAM_TSTRB => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TSTRB,
        OUTPUT_STREAM_TUSER => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TUSER,
        OUTPUT_STREAM_TLAST => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TLAST,
        OUTPUT_STREAM_TID => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TID,
        OUTPUT_STREAM_TDEST => grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDEST);
    ...
    grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg <= ap_const_logic_0;
            else
                if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
                    grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_wrapped_csdr_pgd_hw_fu_128_ap_ready = ap_const_logic_1)) then 
                    grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_data_V_1_load_A)) then
                OUTPUT_STREAM_data_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_data_V_1_load_B)) then
                OUTPUT_STREAM_data_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDATA;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_dest_V_1_load_A)) then
                OUTPUT_STREAM_dest_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDEST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_dest_V_1_load_B)) then
                OUTPUT_STREAM_dest_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TDEST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_id_V_1_load_A)) then
                OUTPUT_STREAM_id_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TID;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_id_V_1_load_B)) then
                OUTPUT_STREAM_id_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TID;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_keep_V_1_load_A)) then
                OUTPUT_STREAM_keep_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TKEEP;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_keep_V_1_load_B)) then
                OUTPUT_STREAM_keep_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TKEEP;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_last_V_1_load_A)) then
                OUTPUT_STREAM_last_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_last_V_1_load_B)) then
                OUTPUT_STREAM_last_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TLAST;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_strb_V_1_load_A)) then
                OUTPUT_STREAM_strb_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TSTRB;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_strb_V_1_load_B)) then
                OUTPUT_STREAM_strb_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TSTRB;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_user_V_1_load_A)) then
                OUTPUT_STREAM_user_V_1_payload_A <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TUSER;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = OUTPUT_STREAM_user_V_1_load_B)) then
                OUTPUT_STREAM_user_V_1_payload_B <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TUSER;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, OUTPUT_STREAM_TREADY, OUTPUT_STREAM_data_V_1_state, OUTPUT_STREAM_keep_V_1_state, OUTPUT_STREAM_strb_V_1_state, OUTPUT_STREAM_user_V_1_state, OUTPUT_STREAM_last_V_1_state, OUTPUT_STREAM_id_V_1_state, OUTPUT_STREAM_dest_V_1_state, grp_wrapped_csdr_pgd_hw_fu_128_ap_done, ap_CS_fsm_state3, ap_CS_fsm_state4)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_wrapped_csdr_pgd_hw_fu_128_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
    ...
    INPUT_STREAM_data_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_data_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_dest_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_dest_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_id_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_id_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_keep_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_keep_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_last_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_last_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_strb_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_strb_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    INPUT_STREAM_user_V_0_ack_out_assign_proc : process(grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY, ap_CS_fsm_state3)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state3)) then 
            INPUT_STREAM_user_V_0_ack_out <= grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TREADY;
        else 
    ...
    OUTPUT_STREAM_data_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_dest_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_id_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_keep_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_last_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_strb_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    OUTPUT_STREAM_user_V_1_vld_in <= grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TVALID;
    ...
    grp_wrapped_csdr_pgd_hw_fu_128_INPUT_STREAM_TVALID <= INPUT_STREAM_dest_V_0_state(0);
    grp_wrapped_csdr_pgd_hw_fu_128_OUTPUT_STREAM_TREADY <= ((ap_CS_fsm_state3 and OUTPUT_STREAM_dest_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_id_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_last_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_user_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_strb_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_keep_V_1_ack_in) or (ap_CS_fsm_state3 and OUTPUT_STREAM_data_V_1_ack_in));
    grp_wrapped_csdr_pgd_hw_fu_128_ap_start <= grp_wrapped_csdr_pgd_hw_fu_128_ap_start_reg;
end behav;
