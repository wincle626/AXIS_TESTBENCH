...
architecture rtl of pgd_f32_AtA_9_rom is 
...
architecture arch of pgd_f32_AtA_9 is
    component pgd_f32_AtA_9_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pgd_f32_AtA_9_rom_U :  component pgd_f32_AtA_9_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
